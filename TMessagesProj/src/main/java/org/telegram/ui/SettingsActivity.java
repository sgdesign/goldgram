...
import org.گلد گرام.PhoneFormat.PhoneFormat;
import org.گلد گرام.android.MediaController;
import org.goldgram.messenger.ApplicationLoader;
import org.goldgram.messenger.BuildVars;
import org.گلد گرام.android.LocaleController;
import org.goldgram.messenger.FileLoader;
import org.goldgram.messenger.SerializedData;
import org.goldgram.messenger.TLClassStore;
import org.goldgram.messenger.TLObject;
...
import org.goldgram.messenger.RPCRequest;
import org.goldgram.messenger.UserConfig;
import org.گلد گرام.android.MessageObject;
import org.گلد گرام.ui.Adapters.BaseFragmentAdapter;
import org.گلد گرام.ui.AnimationCompat.ViewProxy;
import org.گلد گرام.ui.Cells.TextInfoCell;
import org.گلد گرام.ui.Cells.EmptyCell;
import org.گلد گرام.ui.Cells.HeaderCell;
import org.گلد گرام.ui.Cells.ShadowSectionCell;
import org.گلد گرام.ui.Cells.TextCheckCell;
import org.گلد گرام.ui.Cells.TextDetailSettingsCell;
import org.گلد گرام.ui.Cells.TextSettingsCell;
...
import org.گلد گرام.ui.Components.AvatarDrawable;
import org.گلد گرام.ui.Components.AvatarUpdater;
import org.گلد گرام.ui.Components.BackupImageView;
import org.گلد گرام.ui.ActionBar.BaseFragment;
import org.گلد گرام.ui.Components.NumberPicker;
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                if (i == textSizeRow) {
                    ...
                    builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
                    showAlertDialog(builder);
                } else if (i == گلد گرامFaqRow) {
                    try {
                        Intent pickIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(LocaleController.getString("گلد گرامFaqUrl", R.string.گلد گرامFaqUrl)));
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public boolean isEnabled(int i) {
            return i == textSizeRow || i == enableAnimationsRow || i == notificationRow || i == backgroundRow || i == numberRow ||
                    ...
                    i == switchBackendButtonRow || i == گلد گرامFaqRow || i == contactsSortRow || i == contactsReimportRow || i == saveToGalleryRow;
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == textSizeRow) {
                    ...
                    textCell.setText(LocaleController.getString("گلد گرامFAQ", R.string.گلد گرامFaq), true);
                } else if (i == contactsReimportRow) {
                ...
                if (view == null) {
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(String.format(Locale.US, "گلد گرام for Android v%s (%d)", pInfo.versionName, pInfo.versionCode));
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
                }
        ...
        public int getItemViewType(int i) {
            if (i == emptyRow || i == overscrollRow) {
                ...
                return 3;
            } else if (i == notificationRow || i == backgroundRow || i == askQuestionRow || i == sendLogsRow || i == privacyRow || i == clearLogsRow || i == switchBackendButtonRow || i == گلد گرامFaqRow || i == contactsReimportRow || i == textSizeRow || i == languageRow || i == contactsSortRow) {
                return 2;
